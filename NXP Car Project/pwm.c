...
void InitPWM()
{
	...
	PORTA_PCR1 = PORT_PCR_MUX(3) | PORT_PCR_DSE_MASK; //FTM0 Ch6 B1 pin
  PORTA_PCR2 = PORT_PCR_MUX(3) | PORT_PCR_DSE_MASK; //FTM0 Ch7 B2
  PORTC_PCR3 = PORT_PCR_MUX(4) | PORT_PCR_DSE_MASK; //FTM0 Ch2 A1
  PORTC_PCR4 = PORT_PCR_MUX(4) | PORT_PCR_DSE_MASK; //FTM0 Ch3 A2
	PORTC_PCR8 = PORT_PCR_MUX(3) | PORT_PCR_DSE_MASK; //FTM3 Ch4 Servo
